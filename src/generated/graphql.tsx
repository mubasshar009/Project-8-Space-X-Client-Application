...
export type LaunchesQuery = { __typename?: 'Query', launches?: Array<{ __typename?: 'Launch', flight_number?: number | null | undefined, launch_year?: number | null | undefined, launch_success?: boolean | null | undefined, mission_name?: string | null | undefined, upcoming?: boolean | null | undefined } | null | undefined> | null | undefined };

export type LaucnhInfoQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type LaucnhInfoQuery = { __typename?: 'Query', launch?: { __typename?: 'Launch', mission_name?: string | null | undefined, flight_number?: number | null | undefined, launch_year?: number | null | undefined, launch_success?: boolean | null | undefined, details?: string | null | undefined, launch_site?: { __typename?: 'LaunchSite', site_name?: string | null | undefined } | null | undefined, rocket?: { __typename?: 'LaunchRocket', rocket_name?: string | null | undefined, rocket_type?: string | null | undefined } | null | undefined, links?: { __typename?: 'LaunchLinks', video_link?: string | null | undefined, flickr_images?: Array<string | null | undefined> | null | undefined } | null | undefined } | null | undefined };
...
export const LaucnhInfoDocument = gql`
...
/**
 * __useLaucnhInfoQuery__
 *
 * To run a query within a React component, call `useLaucnhInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaucnhInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaucnhInfoQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useLaucnhInfoQuery(baseOptions: Apollo.QueryHookOptions<LaucnhInfoQuery, LaucnhInfoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LaucnhInfoQuery, LaucnhInfoQueryVariables>(LaucnhInfoDocument, options);
      }
export function useLaucnhInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaucnhInfoQuery, LaucnhInfoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LaucnhInfoQuery, LaucnhInfoQueryVariables>(LaucnhInfoDocument, options);
        }
export type LaucnhInfoQueryHookResult = ReturnType<typeof useLaucnhInfoQuery>;
export type LaucnhInfoLazyQueryHookResult = ReturnType<typeof useLaucnhInfoLazyQuery>;
export type LaucnhInfoQueryResult = Apollo.QueryResult<LaucnhInfoQuery, LaucnhInfoQueryVariables>;